      ...
      <AdminGuard>
        <div className="min-h-screen bg-gradient-to-br from-[#f8f7f3ff] to-[#f0eee4ff] flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 dark:text-gray-300">Chargement du template...</p>
          </div>
        </div>
      </AdminGuard>
    )
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#f8f7f3ff] to-[#f0eee4ff] dark:from-gray-900 dark:to-gray-800">
        ...
        <section className="relative bg-gradient-to-br from-[#2a3d26ff] via-[#3b5335ff] to-[#2a3d26ff] text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="text-4xl font-bold mb-2">Modifier le Template</h1>
            <p className="text-xl opacity-90">{name}</p>
            {isDefault && (
              <span className="inline-block mt-2 px-3 py-1 bg-yellow-500 text-sm rounded-full font-semibold">
                Template par défaut (lecture seule pour certains champs)
              </span>
            )}
          </div>
        </section>
